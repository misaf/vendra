...
use App\Filament\Admin\Resources\Geographical\GeographicalCityResource\Pages;
...
final class GeographicalCityResource extends Resource
{
    protected static ?string $model = GeographicalCity::class;

    protected static ?int $navigationSort = 4;

    protected static ?string $slug = 'geographicals/cities';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\SpatieMediaLibraryFileUpload::make('image')
                    ->collection('geographicals/cities')
                    ->columnSpanFull()
                    ->image()
                    ->label(__('form.image')),
    ...
    {
        return [
            'index'  => Pages\ListGeographicalCity::route('/'),
            'create' => Pages\CreateGeographicalCity::route('/create'),
            'view'   => Pages\ViewGeographicalCity::route('/{record}'),
            'edit'   => Pages\EditGeographicalCity::route('/{record}/edit'),
        ];
    }
