...
- Cancel through `CancelOrderAction`, which locks the order and dispatches `Events\OrderCancelled` inside its transaction (not after commit) so stock listeners share the outcome. Calling `Order::cancel()` directly skips the event.
