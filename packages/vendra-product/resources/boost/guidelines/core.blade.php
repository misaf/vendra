...
- Take stock with `Actions\DeductProductStockAction` (locks products in id order, rechecks under the lock, all or nothing, throws `Exceptions\InsufficientProductStockException`) and return it with `Actions\RestockProductsAction`. Never decrement `quantity` inline.
