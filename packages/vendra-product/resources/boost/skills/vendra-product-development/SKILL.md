...
- Stock moves only through `Actions\DeductProductStockAction` (locked in id order, all or nothing, `InsufficientProductStockException`) and `Actions\RestockProductsAction`.
