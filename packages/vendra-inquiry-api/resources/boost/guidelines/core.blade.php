...
- Enforce the current store's `InquirySettings::$occasions` allow-list in `SubmitInquiryProcessor`, where the HTTP operation and the MCP tool meet: `SubmitInquiryRequest::RULES` is a constant and cannot read configuration.
