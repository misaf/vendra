...
return [
    ...
    'brand_name_hint' => 'Shown as the brand name across the console.',
    'billing' => 'Billing',
    'billing_description' => 'The seller and tax shown on every reseller invoice. Plan prices are net; this tax is added to each charge.',
    'seller_name' => 'Seller name',
    'seller_name_hint' => 'The legal name on invoices. Leave empty to use the brand name.',
    'seller_address' => 'Seller address',
    'seller_tax_id' => 'Seller tax ID',
    'tax_rate' => 'Tax rate',
    'tax_rate_hint' => 'Added to every plan charge. Use 0 for no tax.',
    'tax_label' => 'Tax label',
    ...
    'features' => 'Features',
    'limits_hint' => 'Leave a limit empty for unlimited.',
    'unlimited' => 'Unlimited',
